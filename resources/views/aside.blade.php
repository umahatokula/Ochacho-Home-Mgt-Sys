            ...
            <div class="col-12 mt-1">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a id="base-tab1" data-toggle="tab" aria-controls="base-tab1"
                            href="#activity-tab" aria-expanded="true"
                            class="nav-link active"><strong>Activity</strong></a></li>
                            ...
                            <div class="timeline">
                                <ul class="list-unstyled base-timeline activity-timeline ml-0">
                                    ...
                                    <li>
                                        ...
                                        <div class="base-timeline-info"><a href="#"
                                                class="text-uppercase text-primary">Added</a><span
                                                class="d-block">voice mail for conference.</span></div><small
                                            class="text-muted">2 Week Ago</small>
                                    </li>
                                    <li>
                                        ...
                                        <div class="base-timeline-info"><a href="#"
                                                ...
                                                Road.</span></div><small class="text-muted">1 Month Ago</small>
                                    </li>
                                    <li>
                                        ...
                                        <div class="base-timeline-info"><a href="#"
                                                ...
                                                conference.</span></div><small class="text-muted">1 Month
                                            ago</small>
                                    </li>
                                    <li>
                                        <div class="timeline-icon bg-warning"><i class="ft-map-pin"></i></div>
