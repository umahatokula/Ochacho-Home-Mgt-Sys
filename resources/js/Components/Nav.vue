            ...
            <div class="navbar-header">
                ...
                <div class="dropdown ml-2 display-inline-block"><a id="apps" href="#" data-toggle="dropdown"
                    ...
                    <div class="apps dropdown-menu">
                        <div class="arrow_box"><a href="chat.html"
                                class="dropdown-item py-1"><span>Chat</span></a><a href="taskboard.html"
                                class="dropdown-item py-1"><span>TaskBoard</span></a><a href="calendar.html"
                    ...
                    <ul class="navbar-nav">
                                    ...
                                    <div class="noti-list"><a class="dropdown-item noti-container py-2"><i
                                            ...
                                            class="dropdown-item noti-container py-2"><i
                                                ...
                                                class="noti-wrapper"><span
                                                    ...
                                                    sit ametitaque in </span></span></a><a
                                            class="dropdown-item noti-container py-2"><i
                        ...
                        <li class="dropdown nav-item mr-0">
                            <a id="dropdownBasic3" href="#" data-toggle="dropdown"
                                ...
                                <span class="avatar avatar-online" v-if="$page.props.jetstream.managesProfilePhotos">
                                    <img id="navbar-avatar" :src="$page.props.user.profile_photo_url" :alt="$page.props.user.name" />
                                </span>
                            ...
                            <div aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                                <div class="arrow_box_right">
                                    ...
                                    <Link :href="route('profile.show')" class="dropdown-item py-1">
                                        <i class="ft-edit mr-2"></i><span>My Profile</span>
                                    </Link>
                                    
                                    <Link :href="route('profile.show')" class="dropdown-item py-1">
                                        <i class="ft-message-circle mr-2"></i><span>My Chat</span>
                                    </Link>
                                    ...
                                    <a @click.prevent="logout" href="javascript:;" class="dropdown-item"><i class="ft-power mr-2"></i><span>Logout</span></a>
                                </div>
                            </div>
                        </li>
                    </ul>
